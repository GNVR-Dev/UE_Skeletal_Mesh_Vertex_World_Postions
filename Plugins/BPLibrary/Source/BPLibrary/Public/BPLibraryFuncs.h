...
#include "BPLibraryFuncs.generated.h"
...
*/
UCLASS()
class UBPLibraryFuncs : public UBlueprintFunctionLibrary
{
	GENERATED_UCLASS_BODY()

	// UFUNCTION(BlueprintCallable, meta = (DisplayName = "Execute Sample function", Keywords = "BP_Library sample test testing"), Category = "BP_LibraryTesting")
